...
public class work {
    ...
    //Burada main metodumuzu yazmaya başlıyotuz
    public static void main(String args[]){
        ...
        String result = is_include(arr); // hangi değerin üstte tanımlanan static değere eşit olduğunu bulmak için is_inlcude metoduna yolluyoruz.
